...
},{"../dist/index.mjs":"../../node_modules/@stripe/stripe-js/dist/index.mjs"}],"alert.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _stripeJs.loadStripe)('pk_test_51PoiucDQ4X6R2VLm2zZd5AkhuM1fUIXvfXlIjttMOA4OsNLWDvmSvI8aZ63wZkShrCqCIcl2OHi9a1CISDZEZfv700vnOezid5');
        case 3:
          stripePromise = _context.sent;
        case 4:
          return _context.abrupt("return", stripePromise);
        case 5:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 18:
          ...
          console.error('Error booking the tour:', _context2.t0);
...
},{"axios":"../../node_modules/axios/index.js","@stripe/stripe-js":"../../node_modules/@stripe/stripe-js/lib/index.mjs","./alert":"alert.js"}],"login.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.login = exports.logging_out = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var logging_out = exports.logging_out = /*#__PURE__*/function () {
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmFyaHUiLCJhIjoiY2x6MWR1M2p4MnU5ejJrczY3eXNsdzJpciJ9.GZ-yr7D50JryjkYCkgOpnQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/farhu/clz1j451i00jl01podvre5zzg',
    // style URL
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var PasswordSettings = document.querySelector('.form-user-password');
  var save_password_btn = document.querySelector('.btn--save_password');
  ...
  if (logoutbtn) {
    logoutbtn.addEventListener('click', _login.logging_out);
  }
  if (PasswordSettings) {
    PasswordSettings.addEventListener('submit', /*#__PURE__*/function () {
